...
<head>
    ...
    <title>Ducknee F&B</title>
    <link rel="icon" href="images/icon/icon1.webp" type="image/x-icon">
...
<body>
    <div id="wrapper">
        <header>
            <div class="container">
                <section class="logo" style="width: 45%">
                    <a href="index.php"><img src="images/icon/icon1.webp" alt="" ></a>
                </section>
              
                <nav>
                    <ul>
                        <!-- <li><a href="index.php">Ducknee!</a></li> -->
