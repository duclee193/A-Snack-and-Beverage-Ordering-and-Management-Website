<footer>
  <div class="container">
    <div class="logo">
      <a href=""><img style="width: 15%" src="images/icon/icon1.webp" alt=""></a>
      <div class="time" style="padding-left:45%;">
    ...
    <div class="link">
      <div class="col">
        <a href="">Về Ducknee</a>
        <a href="https://leduc.site">Blogs</a>
      </div>
      <!-- <div class="col">
      ...
      <div class="icon" style="padding-left: 100%;">
        <a href="https://www.facebook.com/Duclee.193/"><i class="fab fa-facebook-square"></i></a>
        <a href="https://www.instagram.com/_duclee.193/"><i class="fab fa-instagram-square"></i></a>
